...
const DisplayEducation = ({setActiveTab}) => {
  ...
  return (
    ...
    <div className={display["table"]}>
      <div className={display["column"]}  style={{width: "100%"}}>
        ...
        {(get(profileSelected, 'profile.education', []) || []).map(data => {
          return (
        ...
        {showUpdate && 
            <EditEducation profileSelected={profileSelected} setShowUpdate={setShowUpdate} setActiveTab={setActiveTab}/>    
        }
    </>
  );
};
