...
const EditEducation = ({profileSelected, setShowUpdate, setActiveTab}) => {
  ...
  const handleDelete = (index) => {
    let obj = (get(profileSelected, 'profile.education', []) || []);
    obj = [...obj];
     ...
     {(formikProps) => (
        ...
        <div className={edit["field-group"]}>
          <div className={edit["row"]}>
            ...
            <div className={edit["input-text"]}>
              <div className={edit["label"]}>
                <div className={edit["label-and-icon"]}>
                  <div className={edit["label2"]}>Name of School </div>
                  <svg
          ...
          <div className={edit["row"]}>
            <div className={edit["selection-dropdown2"]}>
              <div className={edit["label"]}>
                <div className={edit["label-and-icon"]}>
                  <div className={edit["label2"]}>Course </div>
                  <svg
      ...
      <div className={display["column"]}  style={{width: "100%"}}>
        <div className={display["header"]} style={{width: "100%"}}>
          <div className={display["content2"]} style={{width: "100%"}}>
            <div className={display["header2"]}>EDUCATIONAL ATTAINMENT</div>
            <div className={display["header2"]}>NAME OF SCHOOL</div>
            <div className={display["header2"]}>COURSE</div>
        ...
        {(get(profileSelected, 'profile.education', []) || []).map((data, index) => {
          return (
            <div className={display["table-item"]}>
          <div className={display["content2"]}>
            <div className={display["juan-dela-cruz"]}>{data.education}</div>
          </div>
          <div className={display["content2"]}>
            <div className={display["juan-dela-cruz"]}>{data.school}</div>
          </div>
          <div className={display["content2"]}>
            <div className={display["juan-dela-cruz"]}>{data.course}</div>
          </div>
          <div className={display["content2"]}>
      ...
      <div className={edit["buttons"]}>
        ...
        <div className={edit["arrow-buttons"]}>
          <div className={edit["icon-button4"]} style={{cursor: "pointer"}} onClick={() => setActiveTab(2)}>
            <svg
          ...
          <div className={edit["icon-button4"]} style={{cursor: "pointer"}} onClick={() => setActiveTab(4)}>
            <svg
