...
const DisplayTraining = ({setActiveTab}) => {
  ...
  return (
    ...
    <div className={display["button"]} onClick={() => setShowUpdate(true)} style={{cursor: "pointer"}}>
      ...
      <div className={display["edit-education-information"]}>
          Edit Trainings / Seminars Information{" "}
      </div>
    </div>
    ...
    <div className={display["table"]}>
      <div className={display["column"]}  style={{width: "100%"}}>
        ...
        {(get(profileSelected, 'profile.training_seminars', []) || []).map(data => {
          return (
        ...
        {showUpdate && 
            <EditTraining profileSelected={profileSelected} setShowUpdate={setShowUpdate} setActiveTab={setActiveTab}/>    
        }
    </>
  );
};
