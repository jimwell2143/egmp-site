...
const EditTraining = ({profileSelected, setShowUpdate, setActiveTab}) => {
  ...
  const handleDelete = (index) => {
    let obj = (get(profileSelected, 'profile.training_seminars', []) || []);
    obj = [...obj];

    obj.splice(index, 1);

    let data = {
      "training_seminars" : obj
    }
     ...
     {(formikProps) => (
        ...
        <div className={edit["field-group"]}>
          <div className={edit["row"]}>
            ...
            <div className={edit["input-text"]}>
              <div className={edit["label"]}>
                <div className={edit["label-and-icon"]}>
                  <div className={edit["label2"]}>Center</div>
                  <svg
          ...
          <div className={edit["row"]}>
            <div className={edit["input-file-upload"]}>
              <div className={edit["label"]}>
                <div className={edit["label-and-icon"]}>
                  <div className={edit["label2"]}>
                    Upload Certificate of Seminar / Training{" "}
                  </div>
                </div>
              </div>
              <input
      ...
      <div className={display["column"]}  style={{width: "100%"}}>
        <div className={display["header"]} style={{width: "100%"}}>
          <div className={display["content2"]} style={{width: "100%"}}>
            <div className={display["header2"]}>TRAINING / SEMINAR</div>
            <div className={display["header2"]}>CENTER</div>
        ...
        {(get(profileSelected, 'profile.training_seminars', []) || []).map((data, index) => {
          return (
            <div className={display["table-item"]}>
          <div className={display["content2"]}>
            <div className={display["juan-dela-cruz"]}>{data.training}</div>
          </div>
          <div className={display["content2"]}>
            <div className={display["juan-dela-cruz"]}>{data.center}</div>
          </div>
          <div className={display["content2"]}>
      ...
      <div className={edit["buttons"]}>
        ...
        <div className={edit["arrow-buttons"]}>
          ...
          <div className={edit["icon-button4"]} style={{cursor: "pointer"}} onClick={() => setActiveTab(6)}>
            <svg
